...
class Settings(qw.QWidget):
    ...
    def __init__(self, other):
        ...
        form = qw.QFormLayout()
        l1 = qw.QLabel("player_name")
        l1.setToolTip("Name eingeben")
        l2 = qw.QLabel("int_speed")
        l2.setToolTip("Anfangsgeschwindigkeit")
        l3 = qw.QLabel("max_speed")
        l3.setToolTip("maximale Geschwindigkeit")
        l4 = qw.QLabel("step_speed")
        l4.setToolTip("")
        l5 = qw.QLabel("initial_snake_size")
        l5.setToolTip("Anfangsgröße der Schlange")
        l6 = qw.QLabel("Game Board Size")
        l6.setToolTip("Größe des Spielfelds")
        l7 = qw.QLabel("Game Board Zoom")
        l7.setToolTip("Zoom")

        form.addRow(l1, self.player_name)
        form.addRow(l2, self.int_speed)
        form.addRow(l3, self.max_speed)
        form.addRow(l4, self.step_speed)
        form.addRow(l5, self.initial_snake_size)
        form.addRow(l6, self.game_board_size)
        form.addRow(l7, self.game_board_zoom)
